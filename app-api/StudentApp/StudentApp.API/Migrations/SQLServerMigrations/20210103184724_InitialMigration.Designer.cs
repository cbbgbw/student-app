...
namespace StudentApp.API.Migrations.SQLServerMigrations
{
    ...
    [Migration("20210103184724_InitialMigration")]
            ...
            modelBuilder.Entity("StudentApp.Services.Model.Definition", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreateTime = new DateTime(2021, 1, 3, 19, 47, 24, 29, DateTimeKind.Local).AddTicks(2986),
                            DefinitionGroupKey = new Guid("00000000-0000-0000-0000-000000000001"),
                            GroupName = "SUBJECT_TYPES",
                            ModifyTime = new DateTime(2021, 1, 3, 19, 47, 24, 29, DateTimeKind.Local).AddTicks(2986),
                            Value = "Laboratoria"
                        },
                        new
                        {
